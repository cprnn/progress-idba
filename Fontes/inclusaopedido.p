...
REPEAT:
    ...
    UPDATE vcli_codigo WITH FRAME f-dados. 
    ...
    IF NOT AVAIL cliente THEN
     ...
     UPDATE vorc_codigo WITH FRAME f-dados.
     UPDATE vrep_codigo WITH FRAME f-dados.
     ...
     UPDATE vtsp_codigo WITH FRAME f-dados.
     ...
     UPDATE vfop_codigo WITH FRAME f-dados.
     ...
     UPDATE vtip_codigo WITH FRAME f-dados.
     ...
     UPDATE vcfo_codigo WITH FRAME f-dados.
     ...
     IF NOT AVAIL cfop THEN
      ...
      IF vconfirma = NO THEN
            UNDO.
      /* Numeração sequencial sem "pular" números, direto na leitura da tabela
      FIND LAST pedido NO-LOCK NO-ERROR.
      
      IF NOT AVAIL pedido THEN
        ASSIGN vped_cod = 1.
      ELSE
        ASSIGN vped_codigo = pedido.ped_codigo + 1.
